  ...
  return (
    <>
      <Head>
        ...
        <script src="https://kit.fontawesome.com/cfdb4bba6b.js" crossOrigin="anonymous"></script>
      ...
      <header className="py-4 px-8">
          <svg className="w-16 h-16" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12.6188 63V28.0909H27.6869C30.2778 28.0909 32.5449 28.5625 34.4881 29.5057C36.4313 30.4489 37.9426 31.8068 39.0222 33.5795C40.1017 35.3523 40.6415 37.4773 40.6415 39.9545C40.6415 42.4545 40.0847 44.5625 38.971 46.2784C37.8688 47.9943 36.3176 49.2898 34.3176 50.1648C32.329 51.0398 30.0051 51.4773 27.346 51.4773H18.346V44.1136H25.4369C26.5506 44.1136 27.4994 43.9773 28.2835 43.7045C29.079 43.4205 29.6869 42.9716 30.1074 42.358C30.5392 41.7443 30.7551 40.9432 30.7551 39.9545C30.7551 38.9545 30.5392 38.142 30.1074 37.517C29.6869 36.8807 29.079 36.4148 28.2835 36.1193C27.4994 35.8125 26.5506 35.6591 25.4369 35.6591H22.096V63H12.6188ZM33.0733 46.9773L41.8006 63H31.5051L22.9824 46.9773H33.0733ZM45.8813 63V28.0909H55.3585V41.7273H67.904V28.0909H77.3813V63H67.904V49.3636H55.3585V63H45.8813Z" fill="#181923" />
          </svg>
        </header>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-wrap justify-center md:justify-between items-center">
              <div className="flex items-center space-x-2 md:space-x-4">
                <a href="https://twitter.com/poyo_eth" className="text-green-500 text-xs md:text-sm underline">
